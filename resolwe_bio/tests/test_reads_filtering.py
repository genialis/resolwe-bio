...
class ReadsFilteringProcessorTestCase(BaseProcessorTestCase, PreparedData):
    ...
    def test_sormerna_single(self):
        ...
        inputs = {
            ...
            'options': {'threads': 2}}
        filtered_reads = self.run_processor('filtering:sortmerna-2.0-single-end', inputs, Data.STATUS_DONE)
    ...
    def test_sortmerna_paired(self):
        ...
        reads = self.run_processor('import:upload:reads-fastq-paired-end', inputs, Data.STATUS_DONE)
        ...
        inputs = {
            ...
            'database_selection': ['rfam-5s-database-id98.fasta'],
            'options': {'threads': 2}}
        filtered_reads = self.run_processor('filtering:sortmerna-2.0-paired-end', inputs, Data.STATUS_DONE)
    ...
    def test_prinseq_paired(self):
        ...
        inputs = {'reads': reads.pk}
        filtered_reads = self.run_processor('filtering:prinseq-lite-20.4:paired-end', inputs, Data.STATUS_DONE)
    ...
    def test_fastqmcf_paired(self):
        ...
        inputs = {'reads': reads.pk}
        filtered_reads = self.run_processor('filtering:fastq-mcf-1.1.2.537:paired-end', inputs, Data.STATUS_DONE)
