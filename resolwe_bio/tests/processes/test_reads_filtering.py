...
class ReadsFilteringProcessorTestCase(BioProcessTestCase):
    ...
    def test_bbduk_beta(self):
        ...
        report = [
            ...
            {
                "file": "fastqc/fw_reads_preprocessed_fastqc/fastqc_report.html",
                "refs": ["fastqc/fw_reads_preprocessed_fastqc"],
            },
        ]
        self.assertFields(filtered_reads, "fastqc_url", report)
        ...
        report = [
            {
                "file": "fastqc/fw_reads_preprocessed_fastqc/fastqc_report.html",
                "refs": [
                    "fastqc/fw_reads_preprocessed_fastqc",
                ],
            },
            {
                "file": "fastqc/fw_reads_2_preprocessed_fastqc/fastqc_report.html",
                "refs": [
                    "fastqc/fw_reads_2_preprocessed_fastqc",
                ],
            },
        ]
        self.assertFields(filtered_reads, "fastqc_url", report)
        ...
        report2 = [
            {
                "file": "fastqc/rw_reads_preprocessed_fastqc/fastqc_report.html",
                "refs": [
                    "fastqc/rw_reads_preprocessed_fastqc",
                ],
            },
            {
                "file": "fastqc/rw_reads_2_preprocessed_fastqc/fastqc_report.html",
                "refs": [
                    "fastqc/rw_reads_2_preprocessed_fastqc",
                ],
            },
        ]
        self.assertFields(filtered_reads, "fastqc_url2", report2)
