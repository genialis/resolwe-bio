...
class WorkflowSTAR(Process):
    """STAR-based RNA-seq pipeline (STAR version 2.7.10b).
    ...
    slug = "workflow-bbduk-star-qc-new"
    name = "STAR-based gene quantification workflow (STAR version 2.7.10b)"
    requirements = {
    ...
    def run(self, inputs, outputs):
        ...
        alignment = Data.create(
            process=BioProcess.get_latest(slug="alignment-star-new"),
            input=input_star,
