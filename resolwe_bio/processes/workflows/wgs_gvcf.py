    ...
    class Input:
        ...
        class Trimming:
            ...
            adapters = DataField(
                ...
                required=False,
                description="Adapter sequence in FASTA format that will "
                "be removed from the read. This field as well as "
                "Seed mismatches, Simple clip threshold and "
                "Palindrome clip threshold parameters are needed to "
                "perform adapter trimming. Minimum adapter length and "
                "Keep both reads are optional parameters.",
            )
