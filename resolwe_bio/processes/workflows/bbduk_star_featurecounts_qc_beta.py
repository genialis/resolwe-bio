...
class WorkflowBBDukStarFcQC(Process):
    ...
    slug = "workflow-bbduk-star-featurecounts-qc-beta"
    name = "BBDuk - STAR - featureCounts - QC (beta)"
    requirements = {
    ...
    def run(self, inputs, outputs):
        ...
        alignment = Data.create(
            process=BioProcess.get_latest(slug="alignment-star-beta"),
            input=input_star,
        ...
        quantification = Data.create(
            process=BioProcess.get_latest(slug="feature_counts-beta"),
