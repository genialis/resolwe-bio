...
class WorkflowATACSeq(Process):
    ...
    It is comprised of three steps; alignment, pre-peakcall QC, and calling peaks (with post-peakcall QC).
    ...
    Finally an optional coverage bigWig file and a MultiQC report are generated.
    """
    ...
    class Input:
        ...
        class BigWigOptions:
            ...
            output_bigwig = BooleanField(
                label="Generate coverage bigWig file",
                default=True,
                description="If selected, coverage bigWig file will be generated using bamCoverage tool.",
            )
        ...
        class AdvancedOptions:
            ...
            output_multiqc = BooleanField(
                label="Generate MultiQC report",
                default=True,
                description="If selected, MultiQC report will be generated at the end of the workflow.",
            )
    ...
    def run(self, inputs, outputs):
        ...
        if inputs.bigwig_options.output_bigwig:
            bigwig_input = {
                "alignment": alignment,
        ...
        if inputs.advanced_options.output_multiqc:
            Data.create(
                process=BioProcess.get_latest(slug="multiqc"),
                input={"data": [alignment, macs2]},
