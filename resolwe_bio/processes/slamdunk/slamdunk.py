...
from resolwe.process import BooleanField, Cmd, DataField, IntegerField, FileField, Process, StringField
...
class SlamdunkAllPaired(Process):
    ...
    def run(self, inputs, outputs):
        ...
        if os.path.isfile(bam_file):
            ...
            Cmd['bamtobigwig.sh']([bam_file, inputs.regions.species, self.requirements.resources.cores])
