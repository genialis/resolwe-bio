...
class CollectRrbsMetrics(Process):
    ...
    def run(self, inputs, outputs):
        ...
        args = [
            ...
            '--REFERENCE', inputs.genome.fasta.path,
            '--METRICS_FILE_PREFIX', name,
            '--C_QUALITY_THRESHOLD', inputs.min_quality,
            '--NEXT_BASE_QUALITY_THRESHOLD', inputs.next_base_quality,
            '--MINIMUM_READ_LENGTH', inputs.min_lenght,
