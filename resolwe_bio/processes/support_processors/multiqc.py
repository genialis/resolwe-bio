    ...
    def run(self, inputs, outputs):
        ...
        for d in inputs.data:
            ...
            if d.process.type.startswith("data:reads:fastq:single"):
                ...
                create_symlink(d.output.metrics_file.path, os.path.join(sample_dir, name))
                ...
                if d.output.build == "rRNA":
                    ...
                    create_symlink(d.output.stats.path, os.path.join(sample_dir, rrna_report))
                    ...
                    create_symlink(d.output.stats.path, os.path.join(sample_dir, report))
                ...
                create_symlink(d.output.counts_summary.path, os.path.join(sample_dir, name))
                ...
                create_symlink(d.output.called_peaks.path, os.path.join(sample_dir, name))
                ...
                try:
                    if os.path.isfile(d.output.control_prepeak_qc.path):
                        ...
                        chip_seq_prepeak_reports.append(d.output.control_prepeak_qc.path)
                except AttributeError:
                    pass
                ...
                try:
                    if os.path.isfile(d.output.enrichment_heatmap.path):
                        ...
                        create_symlink(
                            d.output.enrichment_heatmap.path, os.path.join(sample_dir, name)
                        )
                except AttributeError:
                    pass
                ...
                try:
                    ...
                    create_symlink(d.output.sample_qc.path, os.path.join(sample_dir, name))
                    ...
                    create_symlink(
                        d.output.lane_attributes.path, os.path.join(sample_dir, lane_name)
                    )
